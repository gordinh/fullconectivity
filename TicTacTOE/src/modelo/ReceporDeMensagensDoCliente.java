 ...
 * @author AndreLuiz
 */
public class ReceporDeMensagensDoCliente implements Runnable {

    DatagramSocket clientSocket;
    DatagramPacket receivedPacket;

    public ReceporDeMensagensDoCliente() {
    }
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(ReceporDeMensagensDoCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
